...
def index():
    ...
    if request.method == 'POST':
        ...
        if cvh_numeric == 1:  # Intermediate
            suggestions = "To improve your CVH category, increase physical activity, maintain a healthy diet, and manage weight."
            diet_plan = "Diet Plan: Focus on balanced meals with whole grains, lean proteins, and plenty of fruits and vegetables."
...
def generate_correlation_plot(user_bmi, cvh_numeric):
    ...
    plt.scatter(cvh_numeric, 0, color='red', label='User Input', s=100)
